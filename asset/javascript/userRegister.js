document.getElementById('signup-form').addEventListener('submit', async function (e) {
    ...
    const role = "Buyer"; // Assuming there's a role selection in the form, e.g. "buyer" or "agent"
    ...
    try {
        ...
        if (response.ok) {
            ...
            window.location.href = './userLogin.html'; // Redirect to login page after successful sign-up
        } else {
